            ...
            <div className="mx-auto w-full max-w-8xl px-5 py-32 md:px-10 md:py-24 lg:py-32">
                <div className="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
                    ...
                    <div className="flex justify-center py-10 gap-4">
                        ...
                        <Link
                            href="#"
                            className="flex max-w-full flex-row items-center justify-center rounded-none px-6 py-3 font-semibold text-[#1353fe] [box-shadow:rgb(19,_83,_254)_6px_6px] btn butanimo hover:bg-white" disabled
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
